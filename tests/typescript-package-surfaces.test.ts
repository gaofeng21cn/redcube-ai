...
const PACKAGE_SURFACES = Object.freeze([
  ...
  {
    directory: 'packages/redcube-pack-xiaohongshu',
    ...
    entryMatches: [/export type \{/],
    entryDoesNotMatch: [/buildXhsPlanSlides/, /buildXhsVisualDirection/, /buildXhsRenderHtml/, /compileXhsRenderSlides/],
    typeMatches: [/interface XhsPlanSlide/, /interface XhsVisualDirectionArtifact/, /interface XhsRenderSlide/],
    typeNoAny: true,
  },
  {
    directory: 'packages/redcube-pack-ppt',
    expectedTypesEntry: './src/index.ts',
    packageTsconfigExtends: '../../tsconfig.package-build.json',
    rootReference: true,
    requiredFiles: ['src/index.ts', 'src/types.ts', 'tsconfig.json'],
    entryMatches: [/export type \{/],
    entryDoesNotMatch: [/buildPptOutlineSlides/, /buildPptDetailedOutline/, /buildPptSlideBlueprint/, /buildPptVisualDirection/, /buildPptRenderArtifact/, /compilePptRenderSlides/],
    typeMatches: [/interface PptOutlineSlide/, /interface PptBlueprintArtifact/, /interface PptVisualDirectionArtifact/, /interface PptRenderSlide/],
    typeNoAny: true,
  },
  {
    directory: 'packages/redcube-pack-poster-onepager',
    expectedTypesEntry: './src/index.ts',
    packageTsconfigExtends: '../../tsconfig.package-build.json',
    rootReference: true,
    requiredFiles: ['src/index.ts', 'src/types.ts', 'tsconfig.json'],
    entryMatches: [/export type \{/],
    entryDoesNotMatch: [/buildPosterBlueprint/, /buildPosterVisualDirection/, /buildPosterRenderArtifact/, /compilePosterRenderSlides/],
    typeMatches: [/interface PosterBlueprintArtifact/, /interface PosterVisualDirectionArtifact/, /interface PosterRenderSlide/],
    typeNoAny: true,
  },
  {
  ...
  {
    directory: 'packages/redcube-overlay-registry',
    expectedTypesEntry: './dist/index.d.ts',
    packageTsconfigExtends: '../../tsconfig.package-build.json',
    rootReference: true,
    requiredFiles: ['src/index.ts', 'src/types.ts', 'tsconfig.json'],
    entryMatches: [/getDefaultOverlayRegistry/, /getDefaultOverlayCatalog/, /loadDefaultOverlayEntries/],
    entryDoesNotMatch: [/from '\.\/index\.js'/],
    typeMatches: [/interface DefaultOverlayModuleSpec/, /interface OverlayCatalogSurface/],
    typeNoAny: true,
    tsOnlyFiles: ['src/index.ts'],
  },
  {

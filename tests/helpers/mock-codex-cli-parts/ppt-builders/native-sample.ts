...
function sampleStatusBinding(slideId) {
  return {
    ...
    zone_inset_in_min: 0.15,
    zones: [
      { zone_id: 'title_zone', semantic_role: 'title', bounds: { left_in: 0.85, top_in: 0.45, width_in: 14.3, height_in: 1.2 }, intended_content: 'sample title', min_font_pt: 36, safe_inset_in: 0.15 },
      { zone_id: 'claim_zone', semantic_role: 'claim', bounds: { left_in: 0.85, top_in: 1.72, width_in: 14.3, height_in: 1.1 }, intended_content: 'sample claim', min_font_pt: 18, safe_inset_in: 0.15 },
      ...
      { zone_id: 'proof_zone', semantic_role: 'proof', bounds: { left_in: 0.85, top_in: 6.02, width_in: 14.3, height_in: 1.46 }, intended_content: 'one compact proof band', min_font_pt: 18, safe_inset_in: 0.15 },
    ],
  };
}
  ...
  const nativeShapes = [
    {
      ...
      editable_text: title,
      bounds: { left_in: 0.95, top_in: 0.58, width_in: 13.6, height_in: 0.96 },
      font_size: 36,
      color: '#171C24',
      fill: 'none',
      line: 'none',
    ...
    },
    {
      ...
      bounds: { left_in: 0.95, top_in: 1.9, width_in: 13.6, height_in: 0.9 },
      font_size: 18,
      color: '#5B6570',
      fill: 'none',
      line: 'none',
    },
    {
      ...
      bounds: { left_in: 1.15, top_in: 3.88, width_in: 0.62, height_in: 0.62 },
      fill: '#B94624',
      line: 'none',
    },
    {
      ...
      bounds: { left_in: 0.95, top_in: 6.18, width_in: 13.8, height_in: 1.02 },
      fill: '#EFE6D6',
      line: '#D8C8B2',
    },
    {
      ...
      bounds: { left_in: 1.22, top_in: 6.38, width_in: 12.9, height_in: 0.62 },
      font_size: 18,
      color: '#171C24',
      fill: 'none',
      line: 'none',
    },
    {
      ...
      layout_zone_id: 'proof_zone',
      editable_text: '01',
      bounds: { left_in: 14.28, top_in: 8.02, width_in: 0.7, height_in: 0.46 },
      font_size: 18,
      color: '#5B6570',
      fill: 'none',
      line: 'none',
    ...
    nativeShapes.push(
      {
        ...
        quality_role: 'content',
        layout_zone_id: 'status_zone',
        bounds: { left_in: left, top_in: 3.18, width_in: 4.38, height_in: 1.84 },
        fill: '#FFFFFF',
        line: '#D8C8B2',
      },
      {
        ...
        bounds: { left_in: left + 0.2, top_in: 3.45, width_in: 3.94, height_in: 1.18 },
        font_size: 18,
        color: '#171C24',
        fill: 'none',
        line: 'none',
      },
      {
        ...
        role: 'flow_connector',
        quality_role: 'structural',
        layout_zone_id: pointIndex === 2 ? 'proof_zone' : 'status_zone',
        bounds: pointIndex === 2
          ? { left_in: 12.25, top_in: 5.35, width_in: 0.08, height_in: 0.78 }
          : { left_in: left + 4.2, top_in: 4.08, width_in: 0.36, height_in: 0.04 },
        line: '#B94624',
      },
    );
  }

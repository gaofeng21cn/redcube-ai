...
import { layoutIntentForSlide, slidePoints, stableCompositionSignature } from './native/slide-intent.js';
import { nativeShapePlanForSlide, templateBindingForSlide } from './native/shape-geometry.js';
import { templateLayoutGrammar } from './native/template-grammar.js';
...
export function buildMockPptNativeShapePlan(meta) {
  ...
  return {
    ...
    test_double_boundary: {
      ...
      fixture_owner: 'tests/helpers/mock-codex-cli-parts/ppt-builders/native.js',

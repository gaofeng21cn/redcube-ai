...
import { buildMockPptNativeShapePlan } from './mock-codex-cli-parts/ppt-builders/native.js';

const MOCK_REDCUBE_PYTHON_COMMAND = JSON.stringify([
  process.execPath,
  '--experimental-strip-types',
  fileURLToPath(new URL('./mock-redcube-python-with-playwright.js', import.meta.url)),
]);

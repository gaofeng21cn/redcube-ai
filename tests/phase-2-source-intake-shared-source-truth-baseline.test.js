...
test('phase-2 minimum baseline contract remains absorbed provenance behind the current publication projection delivery contract convergence tranche', () => {
...
test('phase-2 minimum baseline brief and docs indexes expose the baseline as absorbed provenance while keeping scope honest', () => {
  ...
  assert.equal(brief.includes('当前 active tranche：`Phase 2 publication projection / delivery contract convergence`'), true);

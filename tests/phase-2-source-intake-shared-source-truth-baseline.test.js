...
test('phase-2 minimum baseline contract remains absorbed provenance behind the current family source-truth consumption convergence tranche', () => {
...
test('phase-2 minimum baseline brief and docs indexes expose the baseline as absorbed provenance while keeping scope honest', () => {
  ...
  assert.equal(brief.includes('当前 active tranche：`Phase 2 review / export / gate / audit hardening`'), true);

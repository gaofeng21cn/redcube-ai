...
test('xiaohongshu source context does not programmatically author story framing from source snippets', () => {
  const support = read('packages/redcube-runtime-family-xiaohongshu/src/xiaohongshu-runtime-family-parts/support.js');
  const authoring = read('packages/redcube-runtime-family-xiaohongshu/src/xiaohongshu-runtime-family-parts/authoring.js');
...
test('ppt prompt seed helper does not merge profile-specific creative variants', () => {
  const helper = read('packages/redcube-runtime-family-ppt/src/ppt-deck-runtime-family-parts/core-helpers.js');
...
test('ppt runtime validators do not impose hidden default slide counts', () => {
  ...
  const render = read('packages/redcube-runtime-family-ppt/src/ppt-deck-runtime-family-parts/render.js');
...
test('xiaohongshu runtime does not impose hidden carousel length defaults', () => {
  const authoring = read('packages/redcube-runtime-family-xiaohongshu/src/xiaohongshu-runtime-family-parts/authoring.js');
  const render = read('packages/redcube-runtime-family-xiaohongshu/src/xiaohongshu-runtime-family-parts/render.js');
  const support = read('packages/redcube-runtime-family-xiaohongshu/src/xiaohongshu-runtime-family-parts/support.js');
...
test('poster visual direction does not impose a fixed four-region layout', () => {
  ...
  const authoring = read('packages/redcube-runtime-family-poster-onepager/src/poster-onepager-runtime-parts/authoring.js');
  const render = read('packages/redcube-runtime-family-poster-onepager/src/poster-onepager-runtime-parts/core.js');

...
test('xiaohongshu host-agent mainline owns protected creative outputs instead of JS builders', () => {
...
test('xiaohongshu route artifacts record host-agent creative ownership for story, visual, review, and publish surfaces', async () => {
  ...
  await createDeliverable({
    ...
    title: 'P19 小红书创作权收口',
    goal: '验证小红书主创作权已从 JS builder 收回到 host-agent / director-first mainline',
  });

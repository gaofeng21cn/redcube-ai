...
const TRANCHE_BRIEF = 'docs/phase_2_source_readiness_deep_research_trigger_gate_convergence.md';
...
test('source-readiness deep research trigger+gate convergence becomes the absorbed active tranche without rewriting family ontology', () => {

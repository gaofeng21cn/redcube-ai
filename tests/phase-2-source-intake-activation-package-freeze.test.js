...
test('phase-2 activation package freeze remains a machine-readable completed predecessor after source-readiness deep research trigger gate convergence advanced the same mainline', () => {

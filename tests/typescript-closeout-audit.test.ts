...
const RETIRED_SOURCE_JS_FILES = {
  ...
  'packages/redcube-gateway/src/actions/run-managed-deliverable.ts': 1,
  'packages/redcube-gateway/src/actions/source-research.ts': 1,
  'packages/redcube-gateway/src/actions/supervise-managed-run.ts': 1,
  ...
  'packages/redcube-runtime/src/managed-dag-scheduler.ts': 1,
  'packages/redcube-runtime/src/managed-event-log.ts': 1,
  'packages/redcube-runtime/src/managed-run-liveness.ts': 1,
  'packages/redcube-runtime/src/managed-run-store.ts': 1,

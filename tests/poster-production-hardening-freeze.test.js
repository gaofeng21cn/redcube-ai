...
test('current tracked program truth keeps poster freeze historical while publication projection delivery contract convergence stays on the same source-readiness mainline', () => {

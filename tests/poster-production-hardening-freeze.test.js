...
test('current tracked program truth keeps poster freeze historical while source-readiness deep research trigger gate convergence stays on the same source-readiness mainline', () => {

...
- Brand and material status must be explicit: `approved`, `provided_unverified`, `missing`, or `out_of_scope`; missing or unverified required material yields typed blockers or source gap refs.

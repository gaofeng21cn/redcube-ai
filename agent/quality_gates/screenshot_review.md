...
- Zero readable screenshots or a corrupt/unreadable visual artifact materializes a no-output/failure diagnostic plus quality debt and still allows the next declared stage to start. Missing page manifests, provenance gaps, duplicate hashes, crop risk, field leakage, unreadable layout, ordinary visual QA, or missing material status records non-blocking quality debt plus repair refs; it blocks ready claims, not stage transition.

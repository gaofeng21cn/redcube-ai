...
- Run the focused formal quality loop in fresh OPL StageAttempts: `producer -> reviewer -> repairer -> re_reviewer`, with at most three repair rounds. Reviewer and re-reviewer must use new Codex threads with no producer or repairer conversation inheritance.

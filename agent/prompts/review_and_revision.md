...
- Return pass/quality-debt verdict refs, weak pages, repair targets, and owner receipt refs. Typed blockers are reserved for real hard boundaries. The screenshot-review summary may also return one optional non-authority memory proposal candidate or `skip`; it never accepts/rejects memory.

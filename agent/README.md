...
`contracts/stage_control_plane.json` is the machine-readable Cognitive Kernel binding for this pack. Each visual stage declares prompt, skill, tool affordance, knowledge, strategy, candidate-pool, independent-gate, quality-gate, and handoff refs. These refs preserve the current smooth RCA PPT flow: they guide Codex executor behavior inside a stage, while RCA-owned review/export gates, owner receipts, typed blockers, and artifact authority still decide progression.

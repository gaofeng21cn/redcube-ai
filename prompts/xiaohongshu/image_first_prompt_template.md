...
Use this template when a `xiaohongshu` page should be generated by the Codex executor native imagegen task as a complete bitmap page and then reviewed by RedCube.

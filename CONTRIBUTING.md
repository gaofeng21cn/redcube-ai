...
- 如变更涉及公开仓库边界，优先阅读 [`docs/`](docs/README.md)
- `docs/superpowers/` 目录默认视为本地 AI / Superpowers 文档面，并在 Git 中忽略
...
- 面向外部读者的说明统一写入 `docs/`
- 长期稳定规则统一写入 `docs/policies/`
- 不要再把开发计划、冻结稿和过程痕迹提交到 `docs/superpowers/`

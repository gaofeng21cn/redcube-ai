...
const STAGE_SEQUENCE = {
  ...
  stages: [
    ...
    { stage_id: 'fix_html', prompt_file: 'fix_html.md', output_artifact: 'fix_bundle.json', requires_stages: ['render_html', 'screenshot_review'] },
...
const DISPLAY_REGISTRY = {
  surfaces: [
    ...
    { id: 'fix_html', kind: 'render_output', required_when: 'always' },

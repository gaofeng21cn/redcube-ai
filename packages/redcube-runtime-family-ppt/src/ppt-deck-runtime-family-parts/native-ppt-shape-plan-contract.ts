      ...
      editable_shape_plan: {
        ...
        template_layout_grammar: {
          ...
          slide_binding_contract: {
            ...
            acceptance_rule: 'Every non-decorative audience-facing shape must bind to a declared zone; the zone bounds and safe inset must make the text/card relationship explicit before officecli materializes the plan.',
          },
        },
        design_spec_lock: {

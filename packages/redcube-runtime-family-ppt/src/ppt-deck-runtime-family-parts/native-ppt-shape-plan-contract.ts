...
const SAMPLE_STATUS_PROOF_BOARD = Object.freeze({
  ...
  layout_description: 'title+claim, input hub -> three large route cards -> one proof band',
...
const SAMPLE_DECISION_PROOF_SPLIT = Object.freeze({
  ...
  layout_description: 'title+claim, left decision panel, right proof stack, decision/proof rail, bottom takeaway',
    ...
    editable_shape_plan: {
      ...
      template_layout_grammar: {
        ...
        reference_discipline: {
          ...
          rule: 'Infer zones, capacity, rhythm, and action-title hierarchy before coordinates.',
        },
        ...
        compact_sample_catalog_rule: 'Catalog exactly sample_status_proof_board + sample_decision_proof_split; sample_proof_band is a shape role, not an archetype.',
        safe_zone_blueprints: safeZoneBlueprints,
        safe_zone_blueprint_rule: safeZoneBlueprints
          ? 'Copy tuple zones into template_layout_binding.zones; keep shapes inside zone safe bounds; enlarge zones before coordinates when needed.'
          : null,
        slide_binding_contract: {
          ...
          acceptance_rule: 'Every non-decorative/non-auxiliary shape, including rails/connectors/bands/hubs and audience text, must bind to a declared sample zone and remain inside it.',
        },
        native_shape_style_schema: {
          ...
          rule: 'Use top-level font_size/margin_in; no nested font{} or text{} style fields.',
        },
      },
      sample_capacity_contract: {
        ...
        evidence_text_rule: 'visible evidence/proof text is one compact sentence; artifact refs stay in metadata',
      ...
      design_spec_lock: {
        ...
        professional_design_brief: {
          ...
          reference_style_family: 'template-profiled status board with proof band',
          first_glance_hierarchy: 'title and claim lead; shared input flows into three route cards and one proof band',
          template_profile_strategy: 'internal semantic master layout with capacity-safe zones',
          capacity_strategy: 'three cards plus one proof sentence at readable native PPT text floors',
          forbidden_amateur_patterns: ['generic equal-card grid', 'artifact inventory ledger', 'decorative title underline'],
        },
      ...
      slides: [
        {
          ...
          native_shapes: {
            ...
            style_schema_rule: 'Use top-level font_size and margin_in. Do not use nested font.size_pt or text.margin_* fields.',
            text_bearing_shapes_require_editable_text: true,
            structural_roles: ['input_hub', 'flow_connector', 'merge_connector', 'proof_band', 'decision_rail', 'proof_rail'],
          },
        },
      ],
    },
          ...
          archetype_catalog: [
            {
              ...
              layout_description: 'Capacity-safe one-slide sample with causality: title and claim at the top, one input hub feeding three large route status cards in the middle, short split/merge connectors above a single full-width proof band at the bottom. Each card carries one concise point that fits within two estimated lines. The takeaway is merged into the claim or proof sentence; there is no separate takeaway panel.',
              required_zones: ['title_zone', 'claim_zone', 'status_zone', 'proof_zone'],
              content_schema: {
                required_shape_roles: ['title', 'core_sentence', 'input_hub', 'flow_connector', 'content_panel', 'point_text', 'proof_band', 'evidence_item'],
                required_shape_role_groups: ['title_text', 'core_claim_text', 'input_hub', 'flow_connector', 'content_container', 'audience_body_text', 'structural_visual', 'evidence_or_metric_text'],
            ...
            },
            {
              ...
              layout_description: 'Capacity-safe one-slide sample with hierarchy: title and claim at the top, left decision panel, right proof stack, visible decision/proof rail, and one bottom takeaway band. The middle area is split, not a row of equal cards.',
              required_zones: ['title_zone', 'claim_zone', 'decision_zone', 'proof_zone', 'takeaway_zone'],
              content_schema: {
                required_shape_roles: ['title', 'core_sentence', 'decision_rail', 'content_panel', 'point_text', 'proof_band', 'metric', 'takeaway'],
                required_shape_role_groups: ['title_text', 'core_claim_text', 'decision_rail', 'content_container', 'audience_body_text', 'structural_visual', 'evidence_or_metric_text', 'takeaway_text'],

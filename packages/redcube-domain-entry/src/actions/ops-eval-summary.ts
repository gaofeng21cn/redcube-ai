...
export function buildRunTelemetrySummary(source: AnyRecord = {}) {
...
export function buildErrorTaxonomySummary(source: AnyRecord = {}) {
  return {
...
export function buildRerunAnalyticsSummary(source: AnyRecord = {}) {
...
export function buildCostSummary(source: AnyRecord = {}) {
...
export function buildQualityDriftSummary({ qualitySummary = {} }: { qualitySummary?: AnyRecord } = {}) {
...
export function buildApprovalThroughputSummary({
  ...
  pendingReviews = [],
  reviewState = null,
}: { status?: unknown; pendingReviews?: unknown; reviewState?: AnyRecord | null } = {}) {
...
export function buildMetricExtensions({ overlay = null, profileId = null }: { overlay?: unknown; profileId?: unknown } = {}) {

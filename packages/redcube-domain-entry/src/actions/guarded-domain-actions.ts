...
export const RCA_PRIVATIZED_FUNCTIONAL_MODULE_AUDIT_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    activeCallerStatus: 'route_run_record_refs_adapter_landed_default_caller_tail',
    migrationAction: 'Keep concrete executor lifecycle/provisioning/receipt adapter, attempt ledger, route-run record persistence, event append/read, stale-running-run audit and generic route dependency/continuation orchestration in OPL generic Agent Executor Adapter and route attempt shell; RCA returns route policy and receipt refs only.',

...
const RCA_PRIVATIZED_FUNCTIONAL_MODULE_AUDIT_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    activeCallers: ['apply_visual_memory_writeback domain handler action', 'domain authority refs projection'],
  ...
  },
  {
    ...
    surface_ref: '/domain_evidence_refs',
    status: 'domain_authority_refs_adapter_landed',
    classification: 'refs_only_adapter',
    opl_generic_primitive: 'workbench_shell',
    oplAbsorbCandidate: true,
    rcaRetains: ['domain_evidence_refs', 'typed_blocker_refs', 'receipt_locator_refs', 'artifact_locator_refs'],
    rca_scope: 'rca_domain_authority_refs_only',
    audit_readout: 'thin_domain_authority_adapter_no_generic_shell_builders',
    codePaths: [
    ...
    activeCallers: [
      'OPL generated product status and workbench consume RCA domain authority refs',
      'domain-handler export consumes domain authority refs',
    ],
    activeCallerStatus: 'thin_domain_authority_refs_adapter_active',
    migrationAction: 'OPL owns the product, status, workbench, Agent Lab, monitor, ledger and workorder shells; RCA returns only domain evidence, typed blocker, receipt and artifact locator refs.',
    retentionReason: 'RCA owns the meaning and authority of its visual evidence, typed blockers, owner receipts and artifact locators.',
  ...
  },
  {
    ...
    activeCallers: ['product status refs', 'domain-handler runtime framework refs'],

...
export function buildOplRuntimeManagerRegistration({
  ...
  return {
    ...
    indexable_surfaces: [
      { surface_id: 'product_entry_registration', surface_kind: 'skill_catalog', ref: '/skill_catalog/skills/0/domain_projection/opl_runtime_manager_registration' },
      { surface_id: 'opl_hosted_stage_runtime', surface_kind: 'opl_hosted_product_entry', ref: '/product_entry_shell/opl_hosted' },
      { surface_id: 'session_continuity', surface_kind: 'session_continuity', ref: '/session_continuity' },
      { surface_id: 'artifact_inventory', surface_kind: 'artifact_inventory', ref: '/artifact_inventory' },
      { surface_id: 'runtime_health', surface_kind: 'runtime_inventory', ref: '/runtime_inventory' },
      { surface_id: 'review_publication_projection_refs', surface_kind: 'review_publication_refs', refs: ['/review_state', '/publication_projection'] },
      { surface_id: 'opl_family_lifecycle_adapter', surface_kind: 'opl_family_lifecycle_adapter', ref: '/opl_family_lifecycle_adapter' },
      { surface_id: 'artifact_locator_contract', surface_kind: 'artifact_locator_contract', ref: '/artifact_locator_contract' },
      { surface_id: 'domain_memory_descriptor_locator', surface_kind: 'domain_memory_descriptor_locator', ref: '/domain_memory_descriptor_locator' },
      { surface_id: 'domain_owner_receipt_contract', surface_kind: 'domain_owner_receipt_contract', ref: '/domain_owner_receipt_contract' },
      { surface_id: 'lifecycle_guarded_apply_proof', surface_kind: 'lifecycle_guarded_apply_proof', ref: '/lifecycle_guarded_apply_proof' },
      { surface_id: 'visual_transition_spec', surface_kind: 'visual_transition_spec', ref: '/visual_transition_spec' },
      { surface_id: 'visual_transition_evaluator', surface_kind: 'visual_transition_evaluator', ref: '/visual_transition_evaluator' },
      { surface_id: 'controlled_visual_stage_attempt', surface_kind: 'controlled_visual_stage_attempt', ref: '/controlled_visual_stage_attempt' },
      { surface_id: 'controlled_memory_apply_proof', surface_kind: 'controlled_memory_apply_proof', ref: '/controlled_memory_apply_proof' },
      { surface_id: 'controlled_soak_no_regression_attempt', surface_kind: 'controlled_soak_no_regression_attempt', ref: '/controlled_soak_no_regression_attempt' },
      { surface_id: 'domain_action_adapter_receipt_refs', surface_kind: 'domain_action_adapter_receipt_refs', ref: '/domain_action_adapter_receipt_refs' },
    ],
    consumable_projection_refs: ['/skill_catalog/skills/0/domain_projection/runtime_continuity', '/product_entry_shell/opl_hosted', '/session_continuity', '/artifact_inventory', '/runtime_inventory', '/review_state', '/publication_projection', '/opl_family_lifecycle_adapter', '/artifact_locator_contract', '/domain_memory_descriptor_locator', '/domain_owner_receipt_contract', '/lifecycle_guarded_apply_proof', '/visual_transition_spec', '/visual_transition_evaluator', '/controlled_visual_stage_attempt', '/controlled_memory_apply_proof', '/controlled_soak_no_regression_attempt', '/domain_action_adapter_receipt_refs'],
    state_index_inputs: {
    ...
    domain_memory_descriptor_locator: {
      ...
      descriptor_id: domainAuthorityRefs?.domain_memory_descriptor_locator?.descriptor_id || 'rca.visual_pattern_memory.descriptor.v1',
      locator_id: domainAuthorityRefs?.domain_memory_descriptor_locator?.locator_id || 'rca.visual_pattern_memory.locator.v1',
    ...
    artifact_locator_contract: { ref: '/artifact_locator_contract' },
    domain_owner_receipt_contract: { ref: '/domain_owner_receipt_contract' },
    lifecycle_guarded_apply_proof: { ref: '/lifecycle_guarded_apply_proof' },
    visual_transition_spec: { ref: '/visual_transition_spec' },
    visual_transition_evaluator: { ref: '/visual_transition_evaluator' },
    controlled_visual_stage_attempt: { ref: '/controlled_visual_stage_attempt' },
    controlled_memory_apply_proof: { ref: '/controlled_memory_apply_proof' },
    controlled_soak_no_regression_attempt: { ref: '/controlled_soak_no_regression_attempt' },
    domain_action_adapter_receipt_refs: { ref: '/domain_action_adapter_receipt_refs' },

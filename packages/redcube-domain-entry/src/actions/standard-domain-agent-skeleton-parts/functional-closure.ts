...
export function buildDomainOwnerReceiptContract() {
  return {
    ...
    efficiency_handoff_owner_projection: {
      ...
      projection_ref: 'redcube product manifest#/rca_efficiency_handoff_projection/target_agent_owner_surface_refs/owner_receipt_contract_ref',
      target_owner_return_ref: 'target-owner-receipt-or-typed-blocker:redcube_ai/oma_developer_patch_work_order_5a1b68cacbd4',
      allowed_return_shapes_ref: 'redcube product manifest#/domain_owner_receipt_contract/allowed_return_shapes',
      refs_only: true,
    ...
    goal_workflow_agent_lab_suite_owner_projection: {
      ...
      projection_ref: 'redcube product manifest#/goal_workflow_agent_lab_suite',
      allowed_return_shapes_ref: 'redcube product manifest#/domain_owner_receipt_contract/allowed_return_shapes',
      refs_only: true,
      projects_receipt_body: false,
      writes_visual_truth: false,

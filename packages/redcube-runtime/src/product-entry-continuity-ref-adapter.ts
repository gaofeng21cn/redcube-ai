...
export const PRODUCT_ENTRY_CONTINUITY_REF_ADAPTER_BOUNDARY = Object.freeze({
  surface_kind: 'product_entry_continuity_ref_adapter_boundary',
  owner: 'redcube_ai',
...
export function loadProductEntryContinuityRef({ entrySessionId }: {
...
export function saveProductEntryContinuityRef({ session }: { session: RuntimeProductEntrySessionRecord }): {

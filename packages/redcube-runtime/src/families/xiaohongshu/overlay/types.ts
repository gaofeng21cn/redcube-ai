...
type XiaohongshuForbiddenTemplateRoute = XiaohongshuLayoutRules['forbidden_template_routes'][number];
...
type XiaohongshuDisplaySurface = XiaohongshuDisplayRegistry['surfaces'][number];
type XiaohongshuDisplaySurfaceId = XiaohongshuDisplaySurface['id'];
type XiaohongshuDisplaySurfaceKind = XiaohongshuDisplaySurface['kind'];
type XiaohongshuDisplaySurfaceCondition = XiaohongshuDisplaySurface['required_when'];

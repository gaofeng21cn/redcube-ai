...
export function buildTemporalAutonomyReadinessProjection({
  ...
  return {
    ...
    status: 'standard_opl_temporal_contract_ready_live_rca_soak_pending',
    can_be_opl_temporal_hosted: true,
    long_time_autonomy_claimed: false,
    ...
    capability_gates: [
      {
        ...
        owner: OPL_OWNER,
        status: 'opl_provider_capability_required',
      ...
      },
      {
        ...
        available_sidecar_actions: productSidecarGuardedActionIds,
      },
      {
    ...
    current_best_next_actions: [
      ...
      },
      {
        ...
        purpose: 'run provider-hosted visual-stage controlled soak against RCA sidecar refs',
      },
      {
        owner: DOMAIN_ID,
        action_ref: 'redcube product sidecar dispatch:emit_domain_owner_receipt',

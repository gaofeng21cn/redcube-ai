...
export const RCA_PRIVATIZED_FUNCTIONAL_MODULE_AUDIT_ITEMS = Object.freeze([
  {
    ...
    classification: 'rca_owned_visual_internal_dag',
  ...
  {
    module_id: 'workspace_receipt_inventory',
    surface_ref: '/workspace_receipt_inventory_projection',
    status: 'refs_only_read_model_landed',
    classification: 'rca_owned_receipt_refs_projection',
    opl_generic_primitive: 'attempt_ledger',
    rca_scope: 'workspace_runtime_receipt_refs_only',
    audit_readout: 'retain_refs_projection',
    tombstone_required: false,
  },
  {
    ...
    status: 'split_owner_boundary_landed',
    classification: 'rca_owned_artifact_authority_consumer_of_opl_handoff_shell',
    opl_generic_primitive: 'artifact_lifecycle',
    rca_scope: 'visual_artifact_gallery_export_and_handoff_refs',
    audit_readout: 'retain_domain_artifact_authority_project_generic_handoff',
    tombstone_required: false,
  },
  {
    ...
    status: 'split_owner_boundary_landed',
    classification: 'rca_owned_visual_review_and_repair_gate_consumer_of_opl_transport',
  ...
  {
    module_id: 'sidecar_status_action_parity',
    ...
    audit_readout: 'retain_thin_projection',
    tombstone_required: false,
  },
]);

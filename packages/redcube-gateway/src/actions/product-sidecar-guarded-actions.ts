...
export const OPL_GENERATED_INTERFACE_CONSUMPTION = Object.freeze({
  ...
  consumer: 'redcube_ai',
  status: 'descriptor_ready_repo_local_handlers_direct_targets_only',
...
export const RCA_PRIVATIZED_FUNCTIONAL_MODULE_AUDIT_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    activeCallerStatus: 'opl_provider_receipt_refs_with_rca_visual_summary',
  ...
  return {
    ...
    physical_deletion_guard: {
      ...
      required_before_remaining_physical_delete: [
        'active_generated_interface_callers_migrated_to_opl_descriptors',

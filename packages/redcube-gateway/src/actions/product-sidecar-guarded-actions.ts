...
export const RCA_PRIVATIZED_FUNCTIONAL_MODULE_AUDIT_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    status: 'generic_runner_migration_candidate',
    classification: 'split_owner_boundary',
    ...
    activeCallers: ['runManagedDeliverable', 'superviseManagedRun', 'evaluate_visual_transition sidecar action', 'OPL hosted attempt receipt fixture'],
    activeCallerStatus: 'active_rca_runner_until_opl_generic_runner_exists',
    migrationAction: 'Move idempotent tick, retry/dead-letter, provider attempt bridge and state-machine runner mechanics to OPL generic runner.',
  ...
  },
  {
    ...
    status: 'durable_store_migration_candidate',
    ...
    rca_scope: 'workspace_scoped_json_store_until_opl_attempt_ledger_replacement',
    ...
    activeCallers: ['redcube product session', 'supervise managed run', 'runtime watch/session projection'],
    activeCallerStatus: 'active_private_json_store',
    migrationAction: 'Replace RCA private JSON run store with OPL attempt ledger/provider receipt storage, leaving RCA to expose locator refs and visual domain summaries.',
    retentionReason: 'Until OPL ledger is the durable owner, RCA needs workspace-local continuity for same-session visual deliverable runs.',
    cannotAbsorbReason: 'OPL should absorb the store mechanics; it must not absorb canonical artifacts, review verdicts or visual run truth.',
    tombstone_required: false,
  },
  {
    module_id: 'product_entry_session_store',
    surface_ref: '/session_continuity',
    status: 'session_shell_migration_candidate',
    classification: 'split_owner_boundary',
    ...
    activeCallers: ['redcube product session', 'product-entry continuation', 'operator loop actions'],
    activeCallerStatus: 'active_private_session_store',
    migrationAction: 'Move generic session shell, resume token, operator navigation and workbench state to OPL/App.',
  ...
  },
  {
    ...
    status: 'generic_intake_shell_migration_candidate',
    classification: 'split_owner_boundary',
    ...
    activeCallers: ['source intake CLI/MCP action', 'source-first fanout', 'product-entry manifest source readiness'],
    activeCallerStatus: 'active_rca_source_intake',
  ...
  },
  {
    ...
    activeCallerStatus: 'active_rca_artifact_authority_with_opl_lifecycle_candidate',
    migrationAction: 'Move generic artifact inventory, gallery, restore/provenance navigation and handoff shell to OPL/App.',
  ...
  },
  {
    ...
    status: 'workbench_shell_migration_candidate',
    ...
    activeCallers: ['redcube product status', 'product-entry manifest', 'product sidecar export', 'operator evidence readiness tests'],
    activeCallerStatus: 'active_refs_only_projection_shell',
  ...
  },
  {
    ...
    activeCallers: ['redcube CLI', 'redcube MCP server', 'family action catalog', 'product sidecar guarded action list'],
    activeCallerStatus: 'active_thin_wrappers_derived_from_canonical_metadata',

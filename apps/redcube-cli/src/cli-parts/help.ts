...
export function buildCommandHelp(commandKey: string): JsonMap | null {
  ...
  const catalog = {
    ...
    'product session': {
      ...
      usage: 'redcube product session --entry-session-id <id> [--workspace-receipt-scaleout-root <dir>[,<dir>...]]',
    ...
    'product manifest': {
      ...
      usage: 'redcube product manifest --workspace-root <dir> [--workspace-receipt-scaleout-root <dir>[,<dir>...]]',
...
export async function buildHelp(domainActions: DomainActionMap): Promise<JsonMap> {
  ...
  return {
    ...
    usage: {
      ...
      productStatus: 'redcube product status --workspace-root <dir> [--workspace-receipt-scaleout-root <dir>[,<dir>...]]',

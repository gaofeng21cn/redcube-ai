...
Its current repo-verified surfaces are `redcube product frontdesk`, `redcube product invoke`, `redcube product federate`, `redcube product session`, and `redcube product manifest`.

...
def quality_metrics(context: dict, checks: dict) -> dict:
    ...
    return {
        ...
        'semantic_visual_evidence_count': context['semantic_visual_evidence_count'],
        'semantic_visual_families': [item['family'] for item in context['semantic_visual_evidence']],
        'semantic_visual_evidence': context['semantic_visual_evidence'],

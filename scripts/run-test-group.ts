...
const META = [
  ...
  'tests/typescript-contract-surfaces.test.ts',
  'tests/typescript-gateway-surfaces.test.ts',
  'tests/typescript-governance-surfaces.test.ts',
  'tests/typescript-high-churn-packages.test.ts',
  'tests/typescript-overlay-surfaces.test.ts',
  'tests/typescript-reference-os-surfaces.test.ts',
  'tests/typescript-runtime-family-surfaces.test.ts',

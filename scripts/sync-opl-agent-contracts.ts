...
const SHARED_FOUNDRY_POLICY_RELEASE = {
...
const SHARED_FOUNDRY_SERIES_DESIGN_PROFILE = {
...
function buildFoundryAgentSeriesContract(stageControlPlane) {
  return {
    ...
    shared_policy_release: SHARED_FOUNDRY_POLICY_RELEASE,
    series_design_profile: SHARED_FOUNDRY_SERIES_DESIGN_PROFILE,
    domain_id: 'redcube',

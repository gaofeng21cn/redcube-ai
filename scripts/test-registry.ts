...
export const TEST_REGISTRY: readonly TestRegistryEntry[] = Object.freeze([
  ...
  { file: 'tests/ppt-native-quality-package-readback.test.js', lane: 'integration', fast: true },
  { file: 'tests/ppt-native-quality-semantic-gates.test.js', lane: 'integration' },
  { file: 'tests/ppt-native-python-layouts.test.js', lane: 'integration', fast: true },

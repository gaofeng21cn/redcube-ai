...
- product-entry manifest/frontdesk/session surface 暴露 `native_ppt_operator_ux`、依赖诊断、proof runner 命令和 native proof artifact inventory；`redcube native-ppt proof` 是受控 helper command，不是第二公开 skill

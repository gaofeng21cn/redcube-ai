...
本审计只关闭八项结构候选。Native PPT 的 live 同源盲评、第三 viewer、owner receipt、visual ready、Temporal long soak 与 production ready 不属于这八项结构完成声明，继续按 active plan 和 machine completion audit 的 typed blocker 读取。

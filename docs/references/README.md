...
Purpose: 索引当前设计支撑材料。
State: support
Machine boundary: reference docs 不作为 runtime input 或 readiness evidence。

- [RCA visual-deliverable Agent ideal state](./rca-visual-deliverable-agent-ideal-state.md)

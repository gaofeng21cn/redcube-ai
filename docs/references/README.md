...
- operator / integration 支撑参考：`rca_executor_routing_config.md`、`integration/opl-family-contract-adoption.md`、`domain_memory_descriptor_locator.md`
...
- 当前结构收薄设计：`rca-overdesign-thinning-design.md`，定义 2026-07-10 八项过度设计候选的目标边界、并行写集和完成门槛；唯一 active completion plan 仍是 `../active/rca-ideal-state-gap-plan.md`。

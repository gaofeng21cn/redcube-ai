...
| 参考文档 | 生命周期状态 | 读者口径 |
| --- | --- | --- |
| `positioning/domain-harness-os-positioning.md` | 合同引用的历史定位参考 | 只读作 legacy internal boundary vocabulary；公开身份仍是 RCA visual delivery，generic framework/runtime 归 OPL。 |

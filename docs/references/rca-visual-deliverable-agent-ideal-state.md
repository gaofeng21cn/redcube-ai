...
User / One Person Lab App / OPL CLI
  ...
  -> RedCube thin domain_action_adapter / service-safe domain entry
...
- OPL queue/wakeup/provider runtime 通过 product domain_action_adapter export/dispatch 进入 RCA。
...
- 当前 OPL 边界读 RCA 的 OPL family contract adoption、stage control projection 和 product domain_action_adapter surface。

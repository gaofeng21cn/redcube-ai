...
这份 policy 固定 `RedCube AI` 的 AI-first 质量边界。长期规则是：结构化 pack、schema、gate、audit、review projection 和 scorecard 只能约束流程、传递证据和表达机械状态；创作判断、视觉判断、审稿判断和最终交付质量判断必须由 AI-authored author / reviewer artifact 持有。

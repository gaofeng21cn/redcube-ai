...
- 文档生命周期规则目前集中在 `../docs_portfolio_consolidation.md` 和 `../references/governance/series-doc-governance-checklist.md`：公开入口先写 RCA 视觉交付身份，OPL 只作为托管运行框架路径；合同引用的旧 program brief 原位降级，无合同引用的旧计划进入 history / tombstone。

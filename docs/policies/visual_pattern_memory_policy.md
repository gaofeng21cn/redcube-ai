...
- after the current OPL+MAS production paper priority closes, run an OPL-hosted controlled visual stage attempt that consumes visual pattern memory refs and emits RCA-owned accepted/rejected receipt refs;

...
11. 同轮也已把 manifest 提升到 family product-entry manifest v2 companion 层：当前会额外带出 `family_orchestration.human_gates / resume_contract`，方便顶层 `OPL` 或其他 caller 看懂 RedCube 当前的 gate 与续跑边界。

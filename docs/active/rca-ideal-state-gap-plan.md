...
| Default-caller tail readback | `contracts/physical_source_morphology_policy.json#/default_caller_tail_readback` | Readback / compact summary / owner-delta pack 只路由当前 role guard、missing evidence 和 typed-blocker ref shape；不执行 physical delete、不签 owner receipt、不创建 typed blocker 实例、不声明 default-caller cutover、visual/export/handoff/domain/production ready 或 App/live readiness。 |

...
这个结论只表示 RCA 不再声明 generated/hosted wrapper、session、workbench、artifact/review/source shell 或 generic runtime owner，且旧 managed runtime 物理实现已删除。以下情况会重新打开功能/结构差距：
